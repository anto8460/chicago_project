...
in Figure 5 of the Appendix \ref{appendix:fig3}. 
...
(Figure 6 of Appendix \ref{appendix:fig4}) smoothing out the outlier values.
...
The Grid Search method was used, as described by LaValle et al, \cite{lavalle2004relationship} and walk-forward train/validation steps were executed for each combination of the selected hyperparameter values. 
